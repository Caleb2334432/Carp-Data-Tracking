...
const regions = {
  ...
  style: "absolute left-[204px] top-[144px] w-[138px] h-[42px] rounded-tl-[60px] rounded-tr-[50px] rounded-bl-[0px] rounded-br-[0px] rotate-[-106deg] z-[9999] flex items-center justify-center",
  children: "Region 5",
}
