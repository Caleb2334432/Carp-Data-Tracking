...
const regions = {
  ...
  style: "absolute left-[279px] top-[107px] w-[138px] h-[42px] rotate-[-106deg] rounded-tl-[115px] rounded-tr-[191px] rounded-bl-[0px] rounded-br-[0px] rounded-full border border-black z-[9999]"
}
};
